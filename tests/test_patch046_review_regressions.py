...
@pytest.mark.parametrize("question,scopes,selected", [
    ...
    ("국세와 지방세 중 국세만 체납 조회하고 싶어요.",
     ("national",), "national"),
    ("국세와 지방세 중 지방세만 체납 조회하고 싶어요.",
     ("local",), "local"),
    ("국세와 지방세 체납 조회 방법을 알려 주세요. 국세만 알려 주세요.",
     ("national",), "national"),
    ("집주인의 체납세금 조회 방법을 알려 주세요. 지방세만 알려 주세요.",
     ("local",), "local"),
    ("국세와 지방세 중 국세만 빼고 체납 조회하고 싶어요.",
     ("local",), "local"),
    ("국세와 지방세 중 국세만 아니라 지방세도 체납 조회하고 싶어요.",
     ("national", "local"), "national"),
    ("국세와 지방세 중 국세만이 아니라 지방세도 체납 조회하고 싶어요.",
     ("national", "local"), "national"),
    ("국세만 아니라 지방세도 체납 조회하고 싶어요.",
     ("national", "local"), "national"),
    ("국세만 빼고 지방세 체납 조회 방법은요?", ("local",), "local"),
    ...
    ("임대인의 국세 체납 여부를 조회하려고 납세증명서를 발급받고 싶어요.",
     (), "ordinary"),
    ("임대인의 국세 체납 여부를 확인할 증명서를 발급받고 싶어요.",
     (), "ordinary"),
    ("임대인의 국세 체납 여부를 확인할 납세증명서를 제출하려면 어떻게 준비하나요?",
     (), "ordinary"),
    ("미납국세 열람 신청에 필요한 서류를 알려 주세요.",
     ("national",), "national"),
    ("미납국세 열람 신청할 때 납세증명서가 필요한가요?",
     ("national",), "national"),
    ("미납국세 열람 시 납세증명서를 제출해야 하나요?",
     ("national",), "national"),
    ("납세증명서 없이도 미납지방세 열람을 신청할 수 있나요?",
     ("local",), "local"),
    ("납세증명서 없이 미납국세 열람 안내를 받고 싶어요.",
     ("national",), "national"),
    ("미납국세 열람에 납세증명서는 필요 없나요?",
     ("national",), "national"),
    ("납세증명서 발급 여부와 관계없이 미납국세 열람 신청이 가능한가요?",
     ("national",), "national"),
    ("미납국세 열람 방법과 납세증명서 발급 방법을 알려 주세요.",
     (), "ordinary"),
