...
- PATCH-012 recognizes repair-cost return requests, prepaid repair follow-ups, and explicit water-use loss during plumbing work. Five development inputs gain the required civil article; the other 195 inputs and all case/guide rankings remain unchanged. No corpus or gold changes. (commit: pending)
