...
from experiments.patch043_case_internal.scripts.case_internal_run import write
...
def main():
    ...
    import torch
    from experiments.patch043_case_internal.profile import load_internal_case_profile
