...
from experiments.patch043_case_internal.retrieval import CaseInternalPolicy, CaseInternalRetriever
...
def test_application_profile_boundary_uses_existing_result_contract():
    from experiments.patch043_case_internal.profile import AppliedCaseInternalService
...
def test_product_factory_rejects_the_retired_experiment_profile(monkeypatch,tmp_path):
...
def test_context_gaps_and_conflicting_overlap_fail_closed():
    from experiments.patch043_case_internal.retrieval import continuous_case_bodies
